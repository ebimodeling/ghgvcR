...
### LOAD TEST FILES ###
single_xml_file <- "inst/config/single_site.xml"
single_json_file <- "inst/config/single_site.json"
multi_xml_file <- "inst/config/multi_site.xml"
multi_json_file <- "inst/config/multi_site.json"
